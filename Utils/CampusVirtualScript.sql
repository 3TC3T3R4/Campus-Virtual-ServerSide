...
CREATE TABLE Deliveries (
	...
	deliveryField VARCHAR(500) NOT NULL,
    rating DECIMAL(18,2),
    comment VARCHAR(100),
    ratedAt DATETIME,
...
VALUES 
    ...
    ('D483BF47-0C91-42F4-BE40-FF7D29ACA763', 'coach3', 'Path 3', 'Description for Path 3', 20, 2);
...
VALUES 
    ('3F5AC9AA-1B09-4C39-9584-5AEAD893D301', '3F5AC9AA-1B09-4C39-9584-5AEAD893D302', 'Course 1', 'Description for Course 1', 5, 2),
    ('CE79D5C8-BEE5-41E3-8BF4-C79DED2E0F52', NULL, 'Course 2', 'Description for Course 2', 5, 1),
    ('D483BF47-0C91-42F4-BE40-FF7D29ACA764', NULL, 'Course 3', 'Description for Course 3', 10, 3);

-- Insertar datos de prueba en la tabla Contents
INSERT INTO [dbo].[Contents] (contentID, courseID, title, description, type, duration, stateContent) 
VALUES 
    ('3F5AC9AA-1B09-4C39-9584-5AEAD893D303', '3F5AC9AA-1B09-4C39-9584-5AEAD893D301', 'Content 1', 'Description for Content 1', 1, 2, 1),
    ('CE79D5C8-BEE5-41E3-8BF4-C79DED2E0F54', 'CE79D5C8-BEE5-41E3-8BF4-C79DED2E0F52', 'Content 2', 'Description for Content 2', 2, 3, 1),
    ('D483BF47-0C91-42F4-BE40-FF7D29ACA765', '3F5AC9AA-1B09-4C39-9584-5AEAD893D301', 'Content 3', 'Description for Content 3', 3, 4, 1);
...
INSERT INTO [dbo].[Deliveries] (contentID, uidUser, deliveryAt, deliveryField, rating, comment, ratedAt, stateDelivery) 
VALUES 
    ('3F5AC9AA-1B09-4C39-9584-5AEAD893D303', 'user1', '2023-04-21 10:00:00', NULL, 4.5, 'Good job!', '2023-04-22 14:30:00', 1),
    ('CE79D5C8-BEE5-41E3-8BF4-C79DED2E0F54', 'user2', '2023-04-22 12:00:00', NULL, NULL, NULL, NULL, 0),
    ('D483BF47-0C91-42F4-BE40-FF7D29ACA765', 'user3', '2023-04-23 09:00:00', NULL, NULL, NULL, NULL, 1);
